...
# ╔═╡ c3d27956-079a-4ce2-975a-5f1fc4b2c862
 using Plots

# ╔═╡ 4c469222-d20f-4d15-a783-269cc8770e69
using PlutoUI

# ╔═╡ 20430cde-95a6-4c94-a4cc-d9892992bf9d
md"""
# Tutorial de  Julia para Otimização
## Aula 01 - Breve introdução ao Julia

### Ministrante
- Luiz-Rafael Santos do ([LABMAC/UFSC/Blumenau](http://labmac.mat.blumenau.ufsc.br))

   - [Página pessoal](https://lrsantos11.github.io)
   * Email para contato: [l.r.santos@ufsc.br](mailto:l.r.santos@ufsc.br) ou [lrsantos11@gmail.com](mailto:lrsantos11@ufsc.br)
   * Repositório do curso no Github: [https://github.com/lrsantos11/Tutorial-Julia-Opt](https://github.com/lrsantos11/Tutorial-Julia-Opt)
"""

# ╔═╡ 0fd12417-bbc3-4fcf-a38d-849ac7904932
md"""
## Como será o curso
- Usaremos o [Julia](www.julialang.org)  através de notebooks [Pluto](plutojl.org) e  [Julia+VSCode](https://www.julia-vscode.org/) 
     - possivelmente por terminal também
    
- Um pouco de teoria e bastante prática (mas não é um curso de otimização ou de modelagem)
...
# ╔═╡ b30f678f-0444-44e7-a0ee-734ca8c5c18a
md"""
## Apresentando Julia   
...
# ╔═╡ 6e9b61e9-a448-4d60-a034-2f9ed69580c8
md"""
 ...
 * Muitos solvers disponíveis de maneira bastante simples usam JuMP 
    * [HiGHs](https://github.com/jump-dev/HiGHS.jl) para otimização linear e inteira
 ...
 * [JuliaSmoothOptimizers (JSO)](https://juliasmoothoptimizers.github.io/) coleção de pacotes em Julia para desenvolvimento, teste e *benchmark* de algoritmos de otimização (não-linear).
    * [NLPModels.jl](https://github.com/JuliaSmoothOptimizers/NLPModels.jl): API para representar problemas de otimização 
    ...
    * [BenchmarkProfiles.jl](https://github.com/JuliaSmoothOptimizers/BenchmarkProfiles.jl) pacote em Julia para gerar os Perfis de Desempenho de Dolan, Moré e Wild, largamente usados para comparar algoritmos de otimização.
      
* [ProximalOperators.jl](https://kul-forbes.github.io/ProximalOperators.jl/stable/)  disponibilizam primitivas de primeira ordem (em particular operadores `prox`) que facilitam a construção de algoritmos para otimização não-suave)

* Facilidade para gerar gráficos e vizualizações usando o ecosistema [Plots](http://docs.juliaplots.org/latest/)

---

* *Curso de otimização com uso de algumas das ferramentas do Julia:* [Otimização em Julia](https://youtube.com/playlist?list=PLOOY0eChA1uyk_01nGJVmcQGvcJq9h6_6) do prof. [Abel Siqueira](https://abelsiqueira.github.io/).

"""

# ╔═╡ 9bfb9547-7276-4f95-b902-9667bee48416
md"""
...
# ╔═╡ 74074167-6297-4fc6-b35b-abc0a9a3b459
md"""
### Notebooks Pluto
* [Pluto] é um notebook reativo que é completamente desenvolvido em Julia
* Pluto tem um gerenciador de pacotes interno, o que significa que:

  1. 🎈 Pacotes são instalados automaticamente quando usarmos os comandos `using` ou `import`
  1. 🎈 Seu ambiente computacional está guarado dentro do arquivo de notebook. Assim, outra pessoa que abrir o seu notebook Pluto vai ter o mesmo ambiente e pacotes qeu vc está utilizando.
  1. 🙋 As duas características anteriores foram pensadas para tornar fácil a escrita e o compartilhamento de notebooks de forma a reproduzir os códigos.


"""

# ╔═╡ 01099bd3-3ef6-4d2c-9265-d9b630c120c6
md"""
#### Como usar pacotes?
   * No Pluto: simplesmente chame o pacote (pode demorar um pouco)
   * Ambiente prórpio do notebook
"""

# ╔═╡ 21d6c88c-7d8b-4482-96b8-55b258356704
md"""
  * Na linha de comando
  * Importante criar ambiente para cada projeto
  ```julia
    julia> ]
    (@v1.10) pkg> activate .
    (NomeDaPasta) pkg> instantiate 
    (NomeDaPasta) pkg> add Plots # se necessário, adicionar outros pacotes
    
  ```"""

# ╔═╡ 7c1f7ee2-44c2-40f6-9237-fec275620e42
md"""
* Um pacote que melhora a usabilidade de Notebooks Pluto é  `PlutoUI.jl`
"""

# ╔═╡ 8d01be2a-8e4d-4c16-a199-3b5ea73522ad
...
begin
    ...
    # Construir um gif animado por adicionar pontos ao gráfico, salvando a cada 10 frames
...
![Benchmark Julia](https://julialang.org/assets/images/benchmarks.svg)
"""
